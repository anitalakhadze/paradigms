...
static const char *const kWelcomeTextFile = "/home/ani/Documents/paradigms/assigns/assign_4/assn-4-rss-news-search-data/welcome.txt";
static const char *const kDefaultFeedsFile = "/home/ani/Documents/paradigms/assigns/assign_4/assn-4-rss-news-search-data/rss-feeds.txt";
static const char *const kStopWordsFile = "/home/ani/Documents/paradigms/assigns/assign_4/assn-4-rss-news-search-data/stop-words.txt";
...
static void BuildIndices(const char *feedsFileName, const hashset *stopWords, hashset *prevSeenArticles, hashset *wordCounts)
{
  FILE *infile;
  streamtokenizer st;
...
static void ProcessFeed(const char *remoteDocumentName, const hashset *stopWords, hashset *prevSeenArticles, hashset *wordCounts)
{
  url u;
...
static void PullAllNewsItems(urlconnection *urlconn, const hashset *stopWords, hashset *prevSeenArticles, hashset *wordCounts)
{
  streamtokenizer st;
...
static void ParseArticle(const char *articleTitle, const char *articleDescription, const char *articleURL, const hashset *stopWords, hashset *wordCounts)
{
  url u;
  urlconnection urlconn;
  streamtokenizer st;
...
static void ScanArticle(streamtokenizer *st, const char *articleTitle, const char *unused, const char *articleURL, const hashset *stopWords, hashset *wordCounts)
{
  int numWords = 0;
  char word[1024];
...
static void ProcessResponse(const char *word, const hashset *stopWords, const hashset *wordCounts)
{
  if (!WordIsWellFormed(word)){
    printf("\tWe won't be allowing words likse \"&s\" into our set of indices.\n", word);
